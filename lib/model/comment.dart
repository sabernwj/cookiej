class Comment {
	...
	Comment({this.createdAt, this.id, this.rootid, this.rootidstr, this.floorNumber, this.text, this.disableReply, this.user, this.mid, this.idstr, this.status, this.readtimetype});
...
class Status {
	...
	Status.fromJson(Map<String, dynamic> json) {
		...
		if (json['pic_urls'] != null) {
			...
			json['pic_urls'].forEach((v) { picUrls.add(v); });
		}
		geo = json['geo'];
		isPaid = json['is_paid'];
...
class Visible {
	...
	Visible({this.type, this.listId, this.listIdstr});

	Visible.fromJson(Map<String, dynamic> json) {
		type = json['type'];
		listId = json['list_id'];
		listIdstr = json['list_idstr'];
	}
	...
	Map<String, dynamic> toJson() {
		...
		data['list_idstr'] = this.listIdstr;
		return data;
	}
}
...
class PicUrls {
  ...
  PicUrls.fromJson(jsonRes) {
    thumbnailPic = jsonRes['thumbnail_pic'];
  }
	Map<String, dynamic> toJson() {
		final Map<String, dynamic> data = new Map<String, dynamic>();
		data['comment_permission_type'] = this.thumbnailPic;
		return data;
	}
}
