...
class PersonalPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _theme = appVM.currentTheme;
    final user = appVM.currentUser;
                      ...
                      GestureDetector(
                        ...
                        child: SizedBox(
                          child: ClipOval(
                            child: Image(
                              image:
                                  PictureRepository.getPictureFromUrl(iconUrl),
                            ),
                          ),
                          width: 64,
                          height: 64,
                              ...
                              onTap: () async {
                                ...
                                showMenu(
                                  ...
                                  position: RelativeRect.fromLTRB(
                                      ...
                                      0),
                                  items:
                                      await getLocalUsersItems(appVM, context),
                                );
                              },
                            )
                          ]),
            ...
            child: Material(
                ...
                child: GridView.count(
                  ...
                  children: <Widget>[
                    ...
                    _buildExpandedItem(const IconData(0x23), Colors.orange[700],
                        '关注的话题', _theme),
                ...
                child: Column(children: [
                  ListTile(
                    ...
                    trailing: CupertinoSwitch(
                      value: _isDarkMode,
                      activeColor: appVM.currentTheme.primaryColor,
                      onChanged: (value) {
                        //存储夜间模式配置
                      },
                    ),
                  ...
                  ListTile(
                    leading: Icon(Icons.palette,
                        color: appVM.currentTheme.primaryColor),
                    title: Text('主题样式'),
                    onTap: () {
  ...
  Future<List<PopupMenuEntry>> getLocalUsersItems(
      AppViewModel vm, BuildContext context) async {
