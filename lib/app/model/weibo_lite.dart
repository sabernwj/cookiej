...
class WeiboLite extends Content {
  ...
  WeiboLite.fromJson(Map<String, dynamic> json) {
    ...
    repostsCount = (json['reposts_count'] is String)
        ? int.parse(json['reposts_count'])
        : json['reposts_count'];
    commentsCount = (json['comments_count'] is String)
        ? int.parse(json['comments_count'])
        : json['comments_count'];
    attitudesCount = (json['attitudes_count'] is String)
        ? int.parse(json['attitudes_count'])
    ...
    if (json['pics'] != null) {
      picUrls = List<String>();
      json['pics'].forEach((v) {
        picUrls.add(PictureRepository.getImgUrlFromId(v['pid']));
      });
    }
