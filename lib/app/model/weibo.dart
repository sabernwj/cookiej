...
class Weibo extends WeiboLite {
  ...
  Weibo.fromJson(Map<String, dynamic> json) : super.fromJson(json) {
    ...
    longText = json['longText'] != null
        ? new LongText.fromJson(json['longText'])
        : null;
    ...
    numberDisplayStrategy = json['number_display_strategy'] != null
        ? new NumberDisplayStrategy.fromJson(json['number_display_strategy'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.hotWeiboTags != null) {
      data['hot_weibo_tags'] =
          this.hotWeiboTags.map((v) => v.toJson()).toList();
    }
